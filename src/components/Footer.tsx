    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">Ótica Pública <span className="text-primary-400">Visão Clara</span></h3>
            <p className="text-gray-300 mb-4">
              Cuidando da sua visão com qualidade e preços acessíveis há mais de 15 anos.
            </p>
          </div>
          ...
          <div>
            ...
            <address className="text-gray-300 not-italic">
              ...
              <p>Email: contato@oticavisaoclara.com.br</p>
            </address>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">© {year} Ótica Pública Visão Clara. Todos os direitos reservados.</p>
