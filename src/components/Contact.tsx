  ...
  return (
    <section id="contato" className="section-container bg-white">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Agende sua Consulta</h2>
          
          <p className="text-lg text-gray-700 mb-8">
            Entre em contato conosco para agendar uma consulta ou tirar suas dúvidas. Nossa equipe está pronta para atendê-lo com excelência!
          </p>
          ...
          <div className="space-y-6 mb-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700">Av. Paulista, 1000 - Bela Vista, São Paulo - SP, 01310-100</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700">contato@oticavisaoclara.com.br</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700">Segunda a Sexta: 9h às 18h<br />Sábado: 9h às 13h</p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 gap-6">
              ...
              <div>
                ...
                <Textarea id="message" placeholder="Escreva sua mensagem aqui..." rows={4} required />
              </div>
            </div>
